...
export const Hero: React.FC<HeroProps> = ({ view, setView }) => {
  return (
    <div className={`
      ...
      ${view !== 'home' 
        ? 'scale-50 md:scale-75' // Smaller scale on mobile when active
        : 'scale-100'
      }
    `}>
  ...
  return (
    <button
      ...
      className={`
        ...
        bg-surface text-foreground transition-all duration-200 ease-out
  ...
  <svg viewBox="0 0 100 100" className="h-60 w-60 overflow-visible drop-shadow-2xl">
    ...
    <g transform="translate(10, 22.5)">
      ...
      <g transform="translate(20, 15) scale(0.8)">
        <rect x="0" y="0" width="50" height="35" rx="2" stroke="white" strokeWidth="2" fill="none" opacity="0.9" />
        <circle cx="15" cy="12" r="4" fill="white" opacity="0.9" />
        <path d="M5 30 L15 18 L25 30 Z" fill="white" opacity="0.9" />
        <path d="M20 30 L35 15 L45 30 Z" fill="white" opacity="0.9" />
      </g>
