...
const CONTACTS: ContactMethod[] = [
  ...
  { id: 'email', label: 'Email', value: 'joseph@aladin.design', type: 'copy', icon: <Mail className="h-10 w-10" /> },
];
        ...
        {CONTACTS.map((contact, index) => {
          ...
          return (
            <Wrapper
              ...
              data-glow="true"
              className={`
                group relative flex h-32 w-full items-center justify-start gap-4 overflow-hidden rounded-2xl px-5
                sm:gap-6 sm:px-8 bg-surface text-foreground transition-all duration-500 ease-premium
            ...
            >
              ...
              <div className="flex min-w-0 flex-col items-start justify-center">
                ...
                <span className="mt-1 truncate max-w-full text-base font-bold sm:text-lg">
                  {contact.value}
                </span>
              </div>
            </Wrapper>
