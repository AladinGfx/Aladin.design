  ...
  return (
    <button
      ...
      className={`
        ...
        h-64 w-64 aspect-square shrink-0
    ...
    >
      ...
      <div className={`
        ...
        ${isActive ? '-translate-y-6 scale-110' : '-translate-y-6 scale-110 md:translate-y-0 md:scale-100 opacity-100 md:opacity-90 group-hover:opacity-100'}
      `}>
      ...
      <span className={`
        absolute bottom-16 text-xl font-bold tracking-widest transition-all duration-500 ease-premium
        md:bottom-20 md:text-2xl lg:bottom-24 lg:text-3xl
        group-hover:translate-y-10 group-hover:opacity-100
        ${isActive ? 'translate-y-10 opacity-100' : 'translate-y-10 opacity-100 md:translate-y-20 md:opacity-0'}
      `}>
        {label}
      </span>
    </button>
